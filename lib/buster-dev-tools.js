...
//                console.log(depKind.s + ': ' + v.dotId + ' -> ' + child.dotId);
    ...
    var build = function(projects, project, done) { // FIXME: this is really a "reduce" step over allProjects, but to comply with this cps style...
        ...
        console.log();
        var dotOutExt = 'svg';  //  'png'   //  
        var kindsStr = depKinds.map(function(dk){ return dk.s; }).join('+');
        var outFileName = 'buster-dependencies_' + kindsStr + '.' + dotOutExt;
        ...
        var dotLines = ['digraph "busterjs dependencies (' + kindsStr + ')" {'
            ,'label="BUSTERJS' 
